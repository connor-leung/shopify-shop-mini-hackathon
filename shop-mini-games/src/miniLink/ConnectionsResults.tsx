        ...
        <div className="pt-12 px-4 pb-8 max-w-xl mx-auto text-center">
          ...
          <div className="mb-6 space-y-2 max-w-md mx-auto">
            ...
            {results.allCategories.map((cat) => {
              const isCorrectlyGuessed = results.solvedCategories.some(
                (solved) => solved.category === cat.category
              );
              ...
              const getDifficultyColor = (difficulty: string) => {
                switch (difficulty.toLowerCase()) {
                  case "easy":
                    return { fill: "#E2F1E2", stroke: "#92D08D" };
                  case "medium":
                    return { fill: "#DBF2EE", stroke: "#82DEBD" };
                  case "hard":
                    return { fill: "#E1D9FD", stroke: "#9C83F8" };
                  case "expert":
                    return { fill: "#F8DBDE", stroke: "#FF967D" };
                  default:
                    return { fill: "#E2F1E2", stroke: "#92D08D" };
                }
              };
                            ...
                            return (
                              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg">
                                <span className="text-xs font-medium text-center px-1 leading-tight text-gray-700">
                                  {productTitle.length > 6
                                    ? productTitle.substring(0, 6) + "..."
                                    : productTitle}
                                </span>
                              </div>
                            );
